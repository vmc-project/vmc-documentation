...
To switch to the **'pro'** tagged version **6.8** (compatible with *vmc 2.1, Geant4 11.4*):
```bash
cd geant4_vmc 
git checkout v6-8
```

To switch to the **'old'** tagged version **6.7.p1** (compatible with *vmc 2.x, Geant4 11.3.*):
```bash 
cd geant4_vmc 
git checkout v6-7-p1
```
