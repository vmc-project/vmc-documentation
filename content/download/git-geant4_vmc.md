...
To switch to the **'pro'** tagged version **6.1.p1** (compatible with *vmc 2.x, Geant4 11.0.x*):
```bash
cd geant4_vmc 
git checkout v6-1-p1
```

To switch to the **'old'** tagged version **5.4** (compatible with *vmc 1.x, Geant4 10.7.x*):
```bash 
cd geant4_vmc 
git checkout v5-4-p2
```
