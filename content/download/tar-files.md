...
| geant4_vmc | 6.8 | [geant4_vmc-6-8.tar.gz](https://github.com/vmc-project/geant4_vmc/archive/v6-8.tar.gz) | *vmc 2.1, ROOT 6.36/06*,<br> *Geant4 11.4 (with embedded CLHEP 2.4.7.2),* <br> *VGM 5.4,* <br> *Garfield 5.0*|
...
| Package | Version | Tar file | Tested with |
|---------|---------|----------| ------------|
| geant4_vmc | 6.7.p1 | [geant4_vmc-6-7-p1.tar.gz](https://github.com/vmc-project/geant4_vmc/archive/v6-7-p1.tar.gz) | *vmc 2.1, ROOT 6.32/08*,<br> *Geant4 11.3[.p1] (with embedded CLHEP 2.4.7.1),* <br> *VGM 5.3.1,* <br> *Garfield 5.0*|
